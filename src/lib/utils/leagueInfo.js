...
export const homepageText = `
  ...
  <p>REDRAFT HISTORY:</p>
  <img src="/DIP_results.png"/> <br><br><br>
`;
...
export const managers = [
     {
       "roster": 995459107865804800,  // ID of the roster that the manager manages (look at the order of the power rankings graph)
       "name": "cpapcun",
       "tookOver": null, // (optional) used if a manager took over a team, delete this line or change to null otherwise
       "location": "Cleveland", // (optional)
       "bio": "Tall Guy",
       "photo": "/managers/cpapcun.jpg", // square ratio recommended (no larger than 500x500)
